...
class Page{
    ...
    //转换格式
    public function get_change($param){
    ...
    public function show() {
        ...
        $parameter = $this->get_change($this->parameter);
      
        //$url = '?'.implode('&',$this->parameter);
        //var_dump($url);die;
        //$url .= '&'.$this->p.'='.urlencode('[PAGE]');
        $this->url = U(MODULE_NAME.'/'.CONTROLLER_NAME.'/'.ACTION_NAME).$parameter;
        /* 计算分页信息 */
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if ($page>0) {
                if($page != $this->nowPage){
                    ...
                    $link_page .= '<li class="actives">' . $page . '</li>';
                }                
            }
